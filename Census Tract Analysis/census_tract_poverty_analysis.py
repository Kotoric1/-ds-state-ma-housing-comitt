# Author: Binan Zhang
# This file merges the poverty rate information for the census tract information where each evcition case occurred, 
# and plot the number of evictions against the poverty rate for each census tract for the analysis of the impact of poverty rate on the eviction numbers
